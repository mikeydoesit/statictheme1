export default function Addresses1() {
    return (
        <div className="addresses1">
            ...
            <div className="addresses1__latest">
                ...
                <span className="addresses1__latest__date">Griffin Road</span>
                <span className="addresses1__latest__total">London</span>
                <span className="addresses1__latest__total">N17 6HX</span>
            </div>
        </div>
    )
}